...
import (
	...
	"github.com/ujianmu/go-skeleton/internal/config"
	"github.com/ujianmu/go-skeleton/internal/errors"
	"github.com/ujianmu/go-skeleton/internal/healthcheck"
	"github.com/ujianmu/go-skeleton/internal/school"
	"github.com/ujianmu/go-skeleton/pkg/accesslog"
...
func buildHandler(logger log.Logger, db *dbcontext.DB, cfg *config.Config) http.Handler {
	...
	school.RegisterHandlers(rg.Group(""),
		school.NewService(school.NewRepository(db, logger), logger),
		authHandler, logger,
	)
